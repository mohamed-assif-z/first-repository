              ...
              <form style={{ marginTop: 20 }}>
                <div>
                  ...
                  <FormControl variant="outlined" style={{ width: "20%", marginLeft: "1%" }}>
                    ...
                    <Select onChange={this.PDOMAIN} id="PDOMAIN" value={this.state.PDOMAIN} labelWidth={55}>
                  ...
                  <FormControl variant="outlined" style={{ width: "100%" }}>
                    ...
                    <Select onChange={this.PFACULTY} value={this.state.PFACULTY!==""?`${this.state.PFACULTY_NAME}-${this.state.PFACULTY}`:""} labelWidth={100}>
