...
class ReviewDetails extends Component {
    ...
    componentDidMount() {
        ...
        axios
            .post("http://localhost:5000/project/review/getAllReview", data)
            .then(res => {
                ...
                if (res.data[0].REVIEW3.R_PROGRESS) {
                    this.setState({
                        icon3: true
                    });
                }
                if (res.data[0].REVIEW4.R_PROGRESS) {
                    this.setState({
                        icon4: true
                    });
                }
                if (res.data[0].REVIEW5.R_PROGRESS) {
                    this.setState({
                        icon5: true
                    });
                }   
