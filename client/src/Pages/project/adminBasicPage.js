...
class basicPage extends Component {
  ...
  componentDidMount() {
    ...
    if (a) {
      ...
      axios
        .post("http://localhost:5000/project/srsForm/getSRSDetails", data)
        .then(res => {
      ...
      axios
        .post(
          "http://localhost:5000/project/basicForm/getBasicFormDetails",
          data
        )
        .then(res => {
          console.log(res.data[0]);
  ...
  updateBasic = () => {
    ...
    if (!data._id || !data.project_and_problem || !data.interdiciplinary || !data.foucs || !data.objectives || !data.methodology || !data.location || !data.duration) {
      ...
      axios
        .post("http://localhost:5000/project/basicForm", data)
